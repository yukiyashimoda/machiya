    ...
    <div className="container">
      <div className="row mb-90 mb-sm-50">
        <div className="col-lg-5 col-xl-4 mb-md-90 mb-sm-50 wow fadeInUp">
          ...
          <p className="mb-0">
            うなぎと酒 まちやでは現在、アルバイトスタッフを募集しています。ご興味のある方は下記の詳細をご確認の上、電話もしくはメールにてご連絡ください。
          </p>
        </div>
      ...
      <div className="row wow fadeInUp" data-wow-delay="0.27s">
        ...
        <ul className="food-menu">
          ...
          <li className="item">
            ...
            <span className="sub5">ホールスタッフ(簡単な調理補助も)</span>
          </li>
          <hr />
          <li className="item">
            <span className="sub3">勤務時間</span>
            <span className="sub5">17:00〜22:00</span>
          </li>
          <hr />
          <li className="item">
            <span className="sub3">時給</span>
            <span className="sub5">¥1,100(経験により要相談)</span>
          </li>
          <hr />
          <li className="item">
            <span className="sub3">勤務日</span>
            <span className="sub5">シフト制：平日・土日祝</span>
          </li>
          <hr />
          <li className="item">
            <span className="sub3">特記事項</span>
            <span className="sub5">賄いあり・交通費支給</span>
          </li>
          <hr />
        </ul>
        ...
        <div className="text-center mt-4">
          {/* 電話をかけるボタン */}
          <a href="tel:011-600-1747" className="btn btn-primary me-2">
            電話をかける
          </a>
          {/* メールを送るボタン */}
          <a href="mailto:info@unagi-machiya.com" className="btn btn-secondary">
            メールを送る
          </a>
        </div>
